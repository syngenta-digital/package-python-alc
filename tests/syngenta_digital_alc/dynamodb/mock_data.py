def get_old_data():
    return {
        "name": "Paul",
        "contact": {"phone": "1111111111", "email": "1@1.com"},
        ...
        "allOf": [
            {
                ...
                "properties": {
                    ...
                    "object_key": {
                        "type": "object",
                        "properties": {"string_key": {"type": "string"}},
                    },
        ...
        "array_objects": [
            {
                ...
                "array_number_key": 5,
                "extra_key": {"extra_child": "extra_value"},
            },
            {"array_string_key": "array_string_2", "array_number_key": 6},
        ],
        "extra_boolean": True,
    }
        ...
        "Records": [
            {
                ...
                "dynamodb": {
                    ...
                    "Keys": {"example_id": {"S": "123456789"}},
                    "NewImage": {
                        "example_id": {"S": "123456789"},
                        "note": {"S": "Hosrawguw verrig zogupap ce so fajdis vub mos sif mawpowpug kif kihane."},
                        "active": {"BOOL": True},
                        "personal": {
                            "M": {
                                "gender": {"S": "male"},
                        ...
                        "transportation": {"L": [{"S": "public-transit"}, {"S": "car-access"}]},
                    },
