...
class ApiGatewayRequestClientTest(unittest.TestCase):
    ...
    def test_request_headers(self):
        self.assertDictEqual(self.RequestClient.headers, {"x-api-key": "SOME-KEY"})
    ...
    def test_request_query_string_parameters(self):
        self.assertDictEqual(self.RequestClient.params, {"name": "me"})

    def test_path_paramters(self):
        self.assertDictEqual(self.RequestClient.path_parameters, {"proxy": "hello"})

    def test_body(self):
        self.assertDictEqual(self.RequestClient.body, {"body_key": "body_value"})

    def test_json(self):
        self.assertDictEqual(self.RequestClient.json, {"body_key": "body_value"})
