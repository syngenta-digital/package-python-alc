...
class RequestClient:
    ...
    def authorizer(self):
        ...
        return self._event.get("requestContext", {}).get(
            "authorizer", self._event.get("headers")
        )
    ...
    def graphql(self):
        try:
            if base64.b64encode(
                base64.b64decode(self._event.get("body"))
            ) == self._event.get("body"):
    ...
    def __str__(self):
        return str({"request": self.request})
